...
static constexpr const char* QZSS_DCX_CAMF_D8_WIND_SPEED_TABLE[] = {
...
static constexpr uint8_t QZSS_DCX_CAMF_D8_WIND_SPEED_BASE = 0;
static constexpr uint8_t QZSS_DCX_CAMF_D8_WIND_SPEED_SIZE = 13;
inline const char* qzss_dcx_camf_d8_wind_speed_lookup(uint8_t id) {
