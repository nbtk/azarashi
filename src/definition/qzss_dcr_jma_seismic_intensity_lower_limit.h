...
inline constexpr const char* QZSS_DCR_JMA_SEISMIC_INTENSITY_LOWER_LIMIT_TABLE[] = {
    "震度0",
    "震度1",
    "震度2",
    "震度3",
...
inline constexpr const char* qzss_dcr_jma_seismic_intensity_lower_limit_lookup(uint8_t id) {
