...
from ...definitions.qzss.dcx.a11_international_library import a11_international_library_code
...
from ...definitions.qzss.dcx.a2_country_region_name import a2_country_region_name
...
from ...definitions.qzss.dcx.a4_hazard_category_and_type import a4_hazard_category
from ...definitions.qzss.dcx.a4_hazard_category_and_type import a4_hazard_definition
from ...definitions.qzss.dcx.a4_hazard_category_and_type import a4_hazard_type
from ...definitions.camf.a5_severity import a5_severity
from ...definitions.camf.a6_hazard_onset_week import a6_hazard_onset_week
from ...definitions.qzss.dcx.a8_hazard_duration import a8_hazard_duration
from ...definitions.camf.a9_type_of_library import a9_type_of_library
from ...definitions.qzss.dcx.c10_instruction_library_for_second_ellipse import c10_instruction_library_for_second_ellipse
from ...definitions.qzss.dcx.c10_instruction_library_for_second_ellipse import c10_instruction_library_for_second_ellipse_code
from ...definitions.qzss.dcx.d_fields import d1_magnitude_on_richter_scale
from ...definitions.qzss.dcx.d_fields import d2_seismic_coefficient
from ...definitions.qzss.dcx.d_fields import d3_azimuth_from_centre_of_main_ellipse_to_epicentre
from ...definitions.qzss.dcx.d_fields import d4_vector_length_between_centre_of_main_ellipse_and_epicentre
from ...definitions.qzss.dcx.d_fields import d5_wave_height
from ...definitions.qzss.dcx.d_fields import d6_temperature_range
from ...definitions.qzss.dcx.d_fields import d7_hurricane_category
from ...definitions.qzss.dcx.d_fields import d8_wind_speed
from ...definitions.qzss.dcx.d_fields import d9_rainfall_amounts
from ...definitions.qzss.dcx.d_fields import d10_damage_category
from ...definitions.qzss.dcx.d_fields import d11_tornado_probability
from ...definitions.qzss.dcx.d_fields import d12_hail_scale
from ...definitions.qzss.dcx.d_fields import d13_visibility
from ...definitions.qzss.dcx.d_fields import d14_snow_depth
from ...definitions.qzss.dcx.d_fields import d15_flood_severity
from ...definitions.qzss.dcx.d_fields import d16_lightning_intensity
from ...definitions.qzss.dcx.d_fields import d17_fog_level
from ...definitions.qzss.dcx.d_fields import d18_drought_level
from ...definitions.qzss.dcx.d_fields import d19_avalanche_warning_level
from ...definitions.qzss.dcx.d_fields import d20_ash_fall_amount_and_impact
from ...definitions.qzss.dcx.d_fields import d21_geomagnetic_scale
from ...definitions.qzss.dcx.d_fields import d22_terrorism_threat_level
from ...definitions.qzss.dcx.d_fields import d23_fire_risk_level
from ...definitions.qzss.dcx.d_fields import d24_water_quality
from ...definitions.qzss.dcx.d_fields import d25_uv_index
from ...definitions.qzss.dcx.d_fields import d26_number_of_cases_per_100000_inhabitants
from ...definitions.qzss.dcx.d_fields import d27_noise_range
from ...definitions.qzss.dcx.d_fields import d28_air_quality_index
from ...definitions.qzss.dcx.d_fields import d29_outage_estimated_duration
from ...definitions.qzss.dcx.d_fields import d30_nuclear_event_scale
from ...definitions.qzss.dcx.d_fields import d31_chemical_hazard_type
from ...definitions.qzss.dcx.d_fields import d32_biohazard_level
from ...definitions.qzss.dcx.d_fields import d33_biohazard_type
from ...definitions.qzss.dcx.d_fields import d34_explosive_hazard_type
from ...definitions.qzss.dcx.d_fields import d35_infection_type
...
from ...definitions.qzss.dcx.message_type import message_type
...
class Decoder(ContextDecoder[Message]):
    def decode(self) -> dcx.Base:
        ...
        self.dcx_message_type = message_type[dcx_message_type]
        self._set_field_flags(dcx_message_type, camf)
        if dcx_message_type == MessageType.NULL_MSG:
            return dcx.NullMsg(**self.get_params())

        self._decode_a1_to_a11(camf)
        if self.ignore_a12_to_a16 is False:
            self._decode_a12_to_a16(camf)
        if self.ignore_a17_to_a18 is False:
            self._decode_a17_to_a18(camf)
        if self.ignore_ex1 is False:
            self._decode_ex1(camf)
        if self.ignore_ex2_to_ex7 is False:
            self._decode_ex2_to_ex7(camf)
        if self.ignore_ex8_to_ex9 is False:
            self._decode_ex8_to_ex9(camf)
    ...
    def _detect_message_type(self, camf: dcx.CAMF) -> MessageType:
        if all(getattr(camf, field) == 0 for field in _NULL_MSG_FIELDS):
            return MessageType.NULL_MSG
        elif camf.a2 == 111:  # japan
            if camf.a3 == 1:  # fmmc
                return MessageType.L_ALERT
            elif camf.a3 == 2 or camf.a3 == 3:  # fdma or related ministries
                return MessageType.J_ALERT
            elif camf.a3 == 4:  # information from local government
                return MessageType.LOCAL_GOV
            else:
                return MessageType.UNKNOWN
        else:  # outside japan
            return MessageType.OUTSIDE_JAPAN

    def _set_field_flags(self, dcx_message_type: MessageType, camf: dcx.CAMF) -> None:
        ...
        if dcx_message_type == MessageType.OUTSIDE_JAPAN:
            self.ignore_ex1 = True
            self.ignore_ex2_to_ex7 = True
            self.ignore_ex8_to_ex9 = True
        elif dcx_message_type == MessageType.L_ALERT:
            ...
            self.ignore_ex2_to_ex7 = True
            self.ignore_ex8_to_ex9 = True
        elif dcx_message_type == MessageType.J_ALERT:
            self.ignore_a12_to_a16 = True
            self.ignore_a17_to_a18 = True
            self.ignore_ex1 = True
            self.ignore_ex2_to_ex7 = True
        elif dcx_message_type == MessageType.LOCAL_GOV:
            if camf.ex3 == camf.ex4 == camf.ex5 == camf.ex6 == camf.ex7 == 0:
                self.ignore_ex2_to_ex7 = True
            self.ignore_ex8_to_ex9 = True
        elif dcx_message_type == MessageType.NULL_MSG:
            self.ignore_a12_to_a16 = True
            self.ignore_a17_to_a18 = True
            self.ignore_ex1 = True
            self.ignore_ex2_to_ex7 = True
    ...
    def _decode_a1_to_a11(self, camf: dcx.CAMF) -> None:
        self.a1_message_type = a1_message_type[camf.a1]
        self.a2_country_region_name = a2_country_region_name[camf.a2]
        self.a3_provider_identifier = (
            a3_provider_identifier_map.get(
                camf.a2,
                a3_provider_identifier_undefined))[camf.a3]
        self.a4_hazard_category = a4_hazard_category[camf.a4]
        self.a4_hazard_type = a4_hazard_type[camf.a4]
        self.a4_hazard_definition = a4_hazard_definition[camf.a4]
        ...
        if 1 <= camf.a7 <= 10080:
            ...
            self.a6a7_hazard_onset_datetime: datetime.datetime | None = hazard_onset
        elif camf.a7 == 0:
    ...
    def _decode_a12_to_a16(self, camf: dcx.CAMF) -> None:
        ...
        self.a13_ellipse_centre_longitude = round(centre_longitude(camf.a13), 6)
        self.a14_ellipse_semi_major_axis = round(semi_axis(camf.a14), 3)
        self.a15_ellipse_semi_minor_axis = round(semi_axis(camf.a15), 3)
    ...
    def _decode_a17_to_a18(self, camf: dcx.CAMF) -> None:
        if camf.a17 == 0 and self.ignore_a12_to_a16 is False:  # B1 – improved resolution of main ellipse
            self.a17_type_of_specific_settings = \
                a17_type_of_specific_settings[camf.a17]
            ...
            self.c1_refined_latitude_of_centre_of_main_ellipse = round(
                centre_latitude(camf.a12) + (180 / 0xFFFF) / 8 * camf.c1, 6
            )
            self.c2_refined_longitude_of_centre_of_main_ellipse = round(
                centre_longitude(camf.a13) + (360 / 0x1FFFF) / 8 * camf.c2, 6  # an eighth of the A13 longitude step
            )
            major = semi_axis(camf.a14)
            delta = major if camf.a14 == 0 else major - semi_axis(camf.a14 - 1)
            self.c3_refined_length_of_semi_major_axis = round(major - delta * camf.c3 / 8, 3)
            minor = semi_axis(camf.a15)
            delta = minor if camf.a15 == 0 else minor - semi_axis(camf.a15 - 1)
            ...
            self.c5_latitude_of_centre_of_hazard = round(centre_latitude(camf.a12) + delta, 6)
            if camf.c6 <= 63:
                delta = -10 + 20 / 0x80 * camf.c6
            else:
                delta = -10 + 20 / 0x80 * (camf.c6 + 1)
            self.c6_longitude_of_centre_of_hazard = round(centre_longitude(camf.a13) + delta, 6)
            ...
            self.c10_instruction_library_for_second_ellipse = \
                c10_instruction_library_for_second_ellipse[camf.c10]
    ...
    def _decode_b4(self, camf: dcx.CAMF) -> None:
        if camf.a4 == 36:  # earthquake
            ...
            self.d6_temperature_range = d6_temperature_range[camf.d6]
            ...
            self.d7_hurricane_category = d7_hurricane_category[camf.d7]
            self.d8_wind_speed = d8_wind_speed[camf.d8]
            self.d9_rainfall_amounts = d9_rainfall_amounts[camf.d9]
        elif camf.a4 == 82:  # tropical cyclone (typhoon)
            camf.d36 = self.extract_field(131, 3)
            camf.d8 = self.extract_field(134, 4)
            camf.d9 = self.extract_field(138, 3)
            self.d36_typhoon_category = d36_typhoon_category[camf.d36]
            self.d8_wind_speed = d8_wind_speed[camf.d8]
            self.d9_rainfall_amounts = d9_rainfall_amounts[camf.d9]
            ...
            self.d8_wind_speed = d8_wind_speed[camf.d8]
            self.d9_rainfall_amounts = d9_rainfall_amounts[camf.d9]
            self.d11_tornado_probability = d11_tornado_probability[camf.d11]
            ...
            self.d8_wind_speed = d8_wind_speed[camf.d8]
            self.d9_rainfall_amounts = d9_rainfall_amounts[camf.d9]
            self.d10_damage_category = d10_damage_category[camf.d10]
            self.d16_lightning_intensity = d16_lightning_intensity[camf.d16]
        elif camf.a4 == 70:  # hail
            camf.d12 = self.extract_field(131, 4)
            self.d12_hail_scale = d12_hail_scale[camf.d12]
        elif camf.a4 == 74:  # rainfall
            camf.d9 = self.extract_field(131, 3)
            camf.d13 = self.extract_field(134, 4)
            self.d9_rainfall_amounts = d9_rainfall_amounts[camf.d9]
            self.d13_visibility = d13_visibility[camf.d13]
        elif camf.a4 == 76:  # snowfall
            camf.d14 = self.extract_field(131, 5)
            camf.d13 = self.extract_field(136, 4)
            self.d14_snow_depth = d14_snow_depth[camf.d14]
            self.d13_visibility = d13_visibility[camf.d13]
        elif camf.a4 == 68:  # flood
            camf.d15 = self.extract_field(131, 2)
            self.d15_flood_severity = d15_flood_severity[camf.d15]
            ...
            camf.d13 = self.extract_field(134, 4)
            self.d17_fog_level = d17_fog_level[camf.d17]
            self.d13_visibility = d13_visibility[camf.d13]
            ...
            self.d18_drought_level = d18_drought_level[camf.d18]
        elif camf.a4 == 33:  # avalanche risk
            camf.d19 = self.extract_field(131, 3)
            self.d19_avalanche_warning_level = d19_avalanche_warning_level[camf.d19]
        elif camf.a4 == 32:  # ash fall
            camf.d20 = self.extract_field(131, 3)
            self.d20_ash_fall_amount_and_impact = d20_ash_fall_amount_and_impact[camf.d20]
            ...
            self.d21_geomagnetic_scale = d21_geomagnetic_scale[camf.d21]
        elif camf.a4 == 103:  # terrorism
            camf.d22 = self.extract_field(131, 3)
            self.d22_terrorism_threat_level = d22_terrorism_threat_level[camf.d22]
        elif camf.a4 == 27 or camf.a4 == 30:  # forest fire or risk of fire
            camf.d23 = self.extract_field(131, 3)
            self.d23_fire_risk_level = d23_fire_risk_level[camf.d23]
            ...
            self.d24_water_quality = d24_water_quality[camf.d24]
        elif camf.a4 == 23:  # uv radiation
            camf.d25 = self.extract_field(131, 4)
            self.d25_uv_index = d25_uv_index[camf.d25]
            ...
            self.d26_number_of_cases_per_100000_inhabitants = \
                d26_number_of_cases_per_100000_inhabitants[camf.d26]
            self.d35_infection_type = d35_infection_type[camf.d35]
        elif camf.a4 == 19:  # noise pollution
            camf.d27 = self.extract_field(131, 4)
            self.d27_noise_range = d27_noise_range[camf.d27]
        elif camf.a4 == 15:  # air pollution
            camf.d28 = self.extract_field(131, 3)
            self.d28_air_quality_index = d28_air_quality_index[camf.d28]
            ...
            self.d29_outage_estimated_duration = d29_outage_estimated_duration[camf.d29]
        elif camf.a4 == 5:  # chemical hazard
            camf.d31 = self.extract_field(131, 4)
            self.d31_chemical_hazard_type = d31_chemical_hazard_type[camf.d31]
            ...
            self.d30_nuclear_event_scale = d30_nuclear_event_scale[camf.d30]
        elif camf.a4 == 4:  # biological hazard
            camf.d32 = self.extract_field(131, 2)
            camf.d33 = self.extract_field(133, 2)
            self.d32_biohazard_level = d32_biohazard_level[camf.d32]
            self.d33_biohazard_type = d33_biohazard_type[camf.d33]
        elif camf.a4 == 6:  # explosive hazard
            camf.d34 = self.extract_field(131, 2)
            self.d34_explosive_hazard_type = d34_explosive_hazard_type[camf.d34]

    def _decode_ex1(self, camf: dcx.CAMF) -> None:
        self.ex1_target_area = ex1_target_area_code_en[camf.ex1]
    ...
    def _decode_ex2_to_ex7(self, camf: dcx.CAMF) -> None:
        ...
        self.ex6_additional_ellipse_semi_minor_axis = round(semi_axis(camf.ex6), 3)
    ...
    def _decode_ex8_to_ex9(self, camf: dcx.CAMF) -> None:
        ...
        if camf.ex8 == 0:  # prefecture code
            ...
            for i in range(4):
                ...
                if key != 0:
                    self.ex9_target_area_list.append(ex1_target_area_code_en[key])
                    self.ex9_target_area_list_ja.append(ex1_target_area_code_ja[key])

    def _build_report(self, dcx_message_type: MessageType) -> dcx.Base:
        if dcx_message_type == MessageType.OUTSIDE_JAPAN:
            return dcx.OutsideJapan(**self.get_params())
        elif dcx_message_type == MessageType.L_ALERT:
            return dcx.LAlert(**self.get_params())
        elif dcx_message_type == MessageType.J_ALERT:
            return dcx.JAlert(**self.get_params())
        elif dcx_message_type == MessageType.LOCAL_GOV:
            return dcx.MTInfo(**self.get_params())
        else:  # has to be an unknown message
            return dcx.Unknown(**self.get_params())
