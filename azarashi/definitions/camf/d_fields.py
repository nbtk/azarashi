...
d2_seismic_coefficient = CodeTable(
    {
        0: '2',
        1: '3',
        2: '4',
...
d6_temperature_range = CodeTable(
    {
        0: 'T ≤ -30°C',
        1: '-30°C < T ≤ -25°C',
        2: '-25°C < T ≤ -20°C',
...
d7_hurricane_category = CodeTable(
    {
...
d11_tornado_probability = CodeTable(
    {
...
d16_lightning_intensity = CodeTable(
    {
...
d19_avalanche_warning_level = CodeTable(
    {
...
d20_ash_fall_amount_and_impact = CodeTable(
    {
...
d21_geomagnetic_scale = CodeTable(
    {
...
d22_terrorism_threat_level = CodeTable(
    {
...
d26_number_of_cases_per_100000_inhabitants = CodeTable(
    {
        0: '0 - 9',
        1: '10 - 20',
        2: '21 - 50',
...
d28_air_quality_index = CodeTable(
    {
...
d29_outage_estimated_duration = CodeTable(
    {
        0: '0 < duration < 30 min',
...
d30_nuclear_event_scale = CodeTable(
    {
        0: 'Unknown',
...
d31_chemical_hazard_type = CodeTable(
    {
        0: 'Explosives',
        1: 'Flammable gases',
...
d34_explosive_hazard_type = CodeTable(
    {
...
d36_typhoon_category = CodeTable(
    {
