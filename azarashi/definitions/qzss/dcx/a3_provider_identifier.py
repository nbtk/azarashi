...
a3_provider_identifier_australia = CodeTable(
    {
...
a3_provider_identifier_fiji = CodeTable(
    {
...
a3_provider_identifier_japan = CodeTable(
    {
...
a3_provider_identifier_thailand = CodeTable(
    {
...
a3_provider_identifier_map: dict[int, CodeTable[int, str]] = {
    10: a3_provider_identifier_australia,
    71: a3_provider_identifier_fiji,
    111: a3_provider_identifier_japan,
    219: a3_provider_identifier_thailand,
}
